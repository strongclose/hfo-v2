  ...
  const Tooltip = ({ children, content }: { children: React.ReactNode; content: string }) => {
    ...
    return (
      <div className="relative inline-block">
        ...
        {isVisible && (
          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg shadow-lg z-20 max-w-xs">
            {content}
