            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="group relative">
                  {feature.primary && (
                    <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"></div>
                  )}
                  <div className={`relative p-8 rounded-3xl ${feature.primary ? 'bg-white' : 'bg-white/90'} backdrop-blur-xl border ${feature.primary ? 'border-blue-200' : 'border-white/20'} shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105`}>
                    {feature.badge && (
                    ...
                    <div className="text-center">
                      <Button
                        ...
                        className={`${feature.primary ? 'bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700' : ''} transition-all duration-300 hover:scale-105`}
                      >
