      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {examplePrompts.map((prompt, index) => (
                      <button
                        ...
                        className="inline-flex items-center px-3 py-2 text-sm bg-blue-100/80 text-blue-700 rounded-lg hover:bg-blue-200/80 transition-colors border border-blue-200/50"
                      >
                        {prompt}
                      </button>
                    ))}
                ...
                <div className="flex-1 overflow-y-auto mb-4 space-y-3">
                  {chatMessages.length === 0 && (
                    <div className="text-center text-gray-500 mt-12">
                      ...
                      <p>Ask me to find the best prices for your care</p>
                    </div>
                  )}
                  ...
                  {isAITyping && (
                    <div className="flex justify-start">
                      <div className="bg-white/90 text-gray-900 border border-gray-200 px-4 py-2 rounded-2xl">
            ...
            <div className="space-y-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">Search Filters</h3>
                    ...
                    <div className="absolute top-full left-0 right-0 z-50 mt-1 bg-white border border-gray-200 rounded-xl shadow-lg max-h-80 overflow-y-auto">
                      {getFilteredProcedures(mainProcedureInput).map((proc) => (
                        ...
                        >
                          ...
                          <div className="text-sm text-gray-500 font-mono">CPT: {proc.code}</div>
                        </button>
                      ))}
                      {getFilteredProcedures(mainProcedureInput).length === 0 && (
                        <div className="px-4 py-3 text-gray-500 text-center">No procedures found</div>
                      )}
                    </div>
                  )}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-4 z-30 space-y-6 max-h-screen overflow-y-auto">
                {/* Compact Filter Tool */}
