...
function ComparePricesPage() {
  ...
  return (
    <>
      <Head>
        <title>
          Compare Healthcare Prices - Find Best Costs | Hospital Fees
        </title>
        <meta
          name="description"
          content="Compare healthcare prices across hospitals, doctors, and procedures. Find the best costs and save money on medical care with our comparison tools."
        />
        <meta
          name="keywords"
          content="compare healthcare prices, medical cost comparison, hospital price comparison, healthcare savings"
        />
      </Head>
