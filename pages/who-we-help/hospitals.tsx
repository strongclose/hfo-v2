...
import { ChevronRight, Hospital, BarChart3, TrendingUp } from "lucide-react";

export default function HospitalsPage() {
  const [currentPage, setCurrentPage] = useState("whoWeHelpHospitals");
          ...
          <div className="w-full px-4 md:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              <div className="text-sm text-muted-foreground mb-6">
                ...
                <ChevronRight className="w-4 h-4 inline mx-2" />
                <span className="text-primary font-medium">For Hospitals</span>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                  Understand your competitive position and optimize pricing
                  strategies with comprehensive market data.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button
                    size="lg"
                    onClick={() => (window.location.href = "/tools/benchmark")}
                  >
