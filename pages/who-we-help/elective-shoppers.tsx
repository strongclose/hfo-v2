...
import { ChevronRight, ShoppingCart, Search, Calculator } from "lucide-react";

export default function ElectiveShoppersPage() {
  const [currentPage, setCurrentPage] = useState("whoWeHelpElectiveShoppers");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1">
        <section className="relative bg-gradient-to-b from-orange-50 via-white to-gray-50 py-16 lg:py-24">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-sm text-muted-foreground mb-6">
                ...
                <span className="text-primary font-medium">
                  For Elective Procedure Shoppers
                </span>
              </div>
              ...
              <div className="text-center">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-foreground">
                  Shop Smart for Elective Procedures
                </h1>
                <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                  Compare costs and quality for planned procedures to get the
                  best value for your healthcare spending.
                </p>
