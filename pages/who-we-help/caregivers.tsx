...
import { ChevronRight, HandHeart, Search, Calculator } from "lucide-react";

export default function CaregiversPage() {
  const [currentPage, setCurrentPage] = useState("whoWeHelpCaregivers");
          ...
          <div className="w-full px-4 md:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              <div className="text-sm text-muted-foreground mb-6">
                ...
                <ChevronRight className="w-4 h-4 inline mx-2" />
                <span className="text-primary font-medium">For Caregivers</span>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                  Navigate healthcare costs for your loved ones with confidence
                  and compassion.
                </p>
