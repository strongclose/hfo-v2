...
import { ChevronRight, DollarSign, Database, Zap } from "lucide-react";

export default function FinancialToolsPage() {
  const [currentPage, setCurrentPage] = useState("whoWeHelpFinancialTools");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1">
        <section className="relative bg-gradient-to-b from-emerald-50 via-white to-gray-50 py-16 lg:py-24">
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
                  Integrate real-time healthcare pricing data into your
